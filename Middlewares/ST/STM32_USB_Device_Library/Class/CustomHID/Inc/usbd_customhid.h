...
#define CUSTOM_HID_EPIN_SIZE                 0x200U
#define CUSTOM_HID_EPIN_TYPE                 EP_TYPE_BULK

#define CUSTOM_HID_EPOUT_ADDR                0x01U
#define CUSTOM_HID_EPOUT_SIZE                0x200U
#define CUSTOM_HID_EPOUT_TYPE                EP_TYPE_BULK
